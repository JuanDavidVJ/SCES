...
@section('content')
    ...
    <form action="/ActaComite" method="post" enctype="multipart/form-data" id="formulario">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="SC_ActaComite_NumeroSolicitud"
                name="SC_ActaComite_NumeroSolicitud">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="SC_ActaComite_EnviarCitacionAntecedentes"
                name="SC_ActaComite_EnviarCitacionAntecedentes">
