...
<head>
	...
	<form action="/impugnaciones" method="post" enctype="multipart/form-data" id="formulario">
	  ...
	  <div class="form-group">
	    ...
	    <input type="text" class="form-control" id="SC_Impugnacion_DescripcionApelacion" name="SC_Impugnacion_DescripcionApelacion" value="{{ old('SC_Impugnacion_DescripcionApelacion') }}">
